 ...
 */
public class WDCategoryUpdateForm extends SlomFinBaseActionForm
{
	public WDCategoryUpdateForm()
	{		
	}
	
	private Integer wdCategoryID;
	private String wdCategoryDescription;
	private Integer wdCategoryInvestorID;
	...
	public Integer getWdCategoryInvestorID() {
		return wdCategoryInvestorID;
	}

	public void setWdCategoryInvestorID(Integer wdCategoryInvestorID) {
		this.wdCategoryInvestorID = wdCategoryInvestorID;
	}

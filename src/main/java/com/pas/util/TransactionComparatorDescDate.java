...
public class TransactionComparatorDescDate implements Comparator<DynamoTransaction>
{
	...
	public int compare(DynamoTransaction trx1, DynamoTransaction trx2)
	{
		...
		int trxDateCompare = trx2.getTransactionPostedDate().compareTo(trx1.getTransactionPostedDate());
		...
		return trx2.getTransactionID().compareTo(trx1.getTransactionID());
	}

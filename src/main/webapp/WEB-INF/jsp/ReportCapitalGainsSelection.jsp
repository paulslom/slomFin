	...
	<colgroup>
	 ...
	 <TR>
	    ...
	    <td class="tableDataRight">
	        Capital Gains Report Selections
	    </td>
     ...
     <TR>
	    ...
	    <td class="tableDataRight">
	   	...
	   	<td ALIGN="left">	       
	        <html:checkbox name="reportCapitalGainsSelectionForm" property="taxable" tabindex="1"/>
	    </td>
	 ...
	 <TR>
 	 ...
 	 <TR>
	    ...
	    <td class="tableDataRight">
	   	...
	   	<td ALIGN="left">	       
	      <html:select name="reportCapitalGainsSelectionForm" property="year" tabindex="2">
